...
def dbo_feature_selection(X, y, iterations=25, population_size=20, alpha=0.9):
    ...
    for it in range(iterations):
        ...
        print(f"[DBO] Iter {it+1}/{iterations} | Best fitness: {best_fitness:.4f}")

    if best_solution is None or best_solution.sum() == 0:
...
def main():
    ...
    np.save("roc_dbo.npy", y_prob.flatten())
